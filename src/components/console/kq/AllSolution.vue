...
export default {
    ...
    methods:{
        getTableList:function(){
          this.$api.problem.solutionlist({problem_id:4}).then(res=>{
        ...
        showModel(){
            ...
            this.solution = {id:0,problem_id:4,title:'',answer_id:'7'};
        },
        // 添加
        createSolution(name){
            this.$refs[name].validate((valid) => {
                if (valid) {
                    ...
                    {
                        this.$api.problem.solutioncreate({problem_id:this.solution.problem_id,title:this.solution.title,answer_id:7}).then(res=>{
                            if(res.code == 200)
                            {
                                this.getTableList();
                            }
