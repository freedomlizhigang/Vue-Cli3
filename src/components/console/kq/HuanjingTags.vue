        ...
        <Form :model="tag" ref="tagValidate" :rules="tagValidate" action="javascript:void(0)">
            ...
            <FormItem label="答案">
                <RadioGroup v-model="tag.answer_id">
                    <Radio label='3'>满意</Radio>
                    <Radio label='4'>不满意</Radio>
                </RadioGroup>
            </FormItem>
        </Form>
    </Modal>
...
export default {
    ...
    methods:{
        getTableList:function(){
          this.$api.problem.taglist({problem_id:2}).then(res=>{
        ...
        showModel(){
            ...
            this.tag = {id:0,problem_id:2,title:'',answer_id:'3'};
        },
        // 添加
        createTag(name){
